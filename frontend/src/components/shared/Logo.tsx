...
const Logo = () => {
    ...
    return (
        <div className="flex justify-start items-center mb-6">
            <Icon onClick={() => navigate('/chat')} icon={`hugeicons:developer`} fontSize={40} className={`bg-linear-to-r cursor-pointer p-1 rounded-md from-[#a456f7] to-[#3d81f6] ${theme === "dark" ? "text-white/70" : "text-gray-800"}`}
            />
